...
- **Part 3 — Auth (register/login/refresh rotation + reuse detection, password reset, email verification), users module + RBAC permission matrix, platform-staff roles replacing the API-key stopgap:** next.
